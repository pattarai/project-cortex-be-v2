                                              ...
                                              <tr style="border-collapse: collapse">
                                                ...
                                                >
                                                  <a
                                                    ...
                                                    ><img
                                                      class="adapt-img"
                                                      src="https://c.tenor.com/lGYkOfHRFUcAAAAM/never-forget-pointing.gif"
                                                      alt
                                                      style="
                                                        display: block;
                                                        border: 0;
                                              ...
                                              <tr style="border-collapse: collapse">
                                                ...
                                                >
                                                  <p
                                                    ...
                                                    "
                                                  >
                                                    Check your Cortex Magic Link
                                                    Below ⬇️ <br />This is Valid
                                                    only for 15 minutes ⌚.
                                                  </p>
                                                  <h1
                                                    style="
                                            ...
                                            <tbody>
                                              <tr style="border-collapse: collapse">
                                                ...
                                                >
                                                  ...
                                                  >
                                                    <b></b><br />
                                                    Cortex features an intuitive
                                                    design and incorporates modules
                                                    like attendance, events, ranking
                                                    that help the club become more
                                                    organized as well as start a
                                                    healthy competition in
                                                    showcasing the members'
                                                    performance. You are free to
                                                    contribute to our project.!<br />
                                                  </p>
                                                </td>
                                              </tr>
                                              <tr style="border-collapse: collapse">
...
export const sendMagicLink = (receiver: string, link: string): void => {
  var transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: process.env.SMTP_EMAIL,
  ...
  var mailOptions = {
    from: "Project Cortex",
    to: receiver,
    subject: "Cortex Account MagicLink",
